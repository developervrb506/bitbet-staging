...
const socials = [
  ...
  { label: "YouTube", href: "#", icon: "/Youtube.svg", width: 20, height: 15 },
  {
    label: "LinkedIn",
    href: "#",
    icon: "/linkedin.svg",
    ...
    >
      <div className="mx-auto max-w-[1440px] px-4 sm:px-6 lg:px-8 relative z-10">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-12 lg:gap-8 pb-16">
          ...
          <div>
            <h3 className="text-white font-sora text-[20px] transition-colors mb-7 font-bold">
              Navigation
            </h3>
        ...
        <div className="border-t border-white/10 pt-6 xl:pt-10 flex flex-col md:flex-row items-start md:items-center justify-between gap-4">
          <p className="text-[#B3B3B3] font-sora text-[20px]">
            Copyright © 2026 <span className="text-[#EB6331]">BitBet</span>. All
            Rights Reserved.
          </p>
