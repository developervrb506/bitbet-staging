...
const homeHeroButtons: HeroButton[] = [
  { label: "Start Betting", href: "/sportsbook", variant: "primary" },
  { label: "View Live Odds", href: "/live-betting", variant: "outline" },
];
...
const homeHeroContent: HeroSectionContent = {
  ...
  subtitle: "WIN BIGGER.",
  description:
    "Experience the thrill of real-time sports wagering with industry-leading odds, instant payouts, and 24/7 live action coverage.",
